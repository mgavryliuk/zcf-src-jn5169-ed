...
PUBLIC void APP_vBdbCallback(BDB_tsBdbEvent *psBdbEvent)
{
    ...
    case BDB_EVENT_APP_START_POLLING:
        DBG_vPrintf(TRACE_NODE_BDB, "NODE CALLBACK: BDB_EVENT_APP_START_POLLING\n");
...
PRIVATE void vAppHandleAfEvent(BDB_tsZpsAfEvent *psZpsAfEvent)
{
    ...
    {
        DBG_vPrintf(TRACE_NODE_AF_CB, "NODE AF CALLBACK: Event endpoint: WXKG07LM_ALT_BASIC_ENDPOINT\n");
    ...
    {
        DBG_vPrintf(TRACE_NODE_AF_CB, "NODE AF CALLBACK: Events endpoint: WXKG07LM_ALT_ZDO_ENDPOINT\n");
...
PRIVATE void vAppHandleZdoEvents(BDB_tsZpsAfEvent *psZpsAfEvent)
{
    ...
    case ZPS_EVENT_NWK_POLL_CONFIRM:
        DBG_vPrintf(TRACE_NODE_ZDO, "APP-ZDO:  ZPS_EVENT_NWK_POLL_CONFIRM\n");
        break;
