...
const tsZCL_AttributeDefinition asCLD_ConfigurationClusterAttributeDefinitions[] = {
    {E_CLD_BUTTON_MODE_ATTR_ID_MODE_TYPE, (E_ZCL_AF_RD | E_ZCL_AF_RP | E_ZCL_AF_WR | E_ZCL_AF_MS), E_ZCL_ENUM8, (uint32)(&((tsCLD_Configuration *)(0))->eButtonMode), 0},
};
    ...
    uint8 *pu8AttributeControlBits)
{
    ...
    {
        ((tsCLD_Configuration *)psClusterInstance->pvEndPointSharedStructPtr)->eButtonMode = E_CLD_BUTTON_MODE_NONE;
    }
